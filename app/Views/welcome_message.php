...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<link rel="stylesheet" href="<?php echo base_url('css/projet.css');?>"/>
	...
	<body>
		...
		<div
			...
			<div class="donneesClientSimple">
				<form action="<?php echo base_url('ClientSimple');?>" method="POST">
					<fieldset class="dataClient" id="forCompteSimple">
						...
						<label for="numCni">Numéro d'identification:
						</label>
						<input type="number" name="numCni" id="numCni" required><br><br>

						<label for="adresse">adresse mail:
						</label>
						<input type="email" name="adresse" id="adresse"><br><br>
			...
			<form action="<?php echo base_url('ClientCourant');?>" method="POST">
				<div class="donneesClientCourant">
					<fieldset class="dataCompteCourant" id="compteCourant">
						<div class="donnees">
							...
							<label for="usernameClient">Prénom:
							</label>
							...
							<label for="adresseClient">adresse mail:
							</label>
							<input type="email" name="adresseClient" id="adresseClient"><br><br>

							<label for="numCniClient">Numéro d'identification:
							</label>
					...
					<form action="<?php echo base_url('ClientBloque');?>" method="POST">
						<fieldset class="dataComptebloque" id="bloque">
							<div class="donneesCompeBloque">
								...
								<label for="clientMail">adresse mail:
								</label>
							...
							<div class="infoClient">
								...
								<label for="remunerationBloque">Remuneration:
								</label>
			...
			<script src="<?php echo base_url('js/projet.js');?>"></script>
		</body>
	</body>
</html>
